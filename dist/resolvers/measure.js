...
var _default = {
  Query: {
    ...
    measures: function () {
      ...
      function measures(_x4, _x5, _x6) {
        return _measures.apply(this, arguments);
      }

      return measures;
    }(),
    measuresInventory: function () {
      var _measuresInventory = _asyncToGenerator(
      /*#__PURE__*/
      ...
      function measuresInventory(_x7, _x8, _x9) {
        return _measuresInventory.apply(this, arguments);
      }

      return measuresInventory;
    }()
  },
  Mutation: {
    createMeasure: function () {
      ...
      function createMeasure(_x10, _x11, _x12) {
    ...
    deleteMeasure: function () {
      ...
      function deleteMeasure(_x13, _x14, _x15) {
    ...
    updateMeasure: function () {
      ...
      function updateMeasure(_x16, _x17, _x18) {
