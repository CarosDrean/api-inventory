...
var _default = {
  Query: {
    ...
    productsInventory: function () {
      var _productsInventory = _asyncToGenerator(
      /*#__PURE__*/
      ...
      function productsInventory(_x7, _x8, _x9) {
        return _productsInventory.apply(this, arguments);
      }
  ...
  Mutation: {
    createProduct: function () {
      ...
      function createProduct(_x10, _x11, _x12) {
    ...
    updateProduct: function () {
      ...
      function updateProduct(_x16, _x17, _x18) {
